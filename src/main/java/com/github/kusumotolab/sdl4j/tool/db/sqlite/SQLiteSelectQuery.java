...
public class SQLiteSelectQuery<T> implements Query<T> {
  ...
  public SQLiteSelectQuery(final String dbName, final List<String> columns,
      ...
      final List<SQLiteOrder> orders, final List<String> groupsBys,
      final SQLiteCondition having, final Function<ResultSet, T> mapper) {
    this.dbName = dbName;
